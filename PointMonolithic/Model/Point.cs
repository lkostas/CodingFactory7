...
public class Point : IEquatable<Point>, IComparable<Point>
{
    ...
    {
        int positionToUpdate = GetPointPotision();
    ...
    public Point? Delete()
    {
        int positionToDelete = GetPointPotision();
    ...
    {
        return _points.Contains(this) ? _points[GetPointPotision()] : null;
    }

    private int GetPointPotision()
    {
